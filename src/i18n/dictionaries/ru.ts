...
export const ru: Dictionary = {
  ...
  leads: {
    ...
    demoReset: {
      ...
      title: "Сбросить синтетические демо-данные?",
      description:
        "Будут заменены только синтетические демо-лиды новым учебным набором. Реальные лиды, операторы и учётные записи не удаляются.",
      confirm: "Сбросить синтетические данные",
      cancel: "Отмена",
      pending: "Сброс демо-данных…",
      successTitle: "Демо-данные сброшены",
      successDescription: "Удалено синтетических лидов: {deleted}. Добавлено демо-лидов: {inserted}.",
      errorTitle: "Не удалось сбросить демо-данные",
      errorConflict: "Сброс уже выполняется. Подождите и попробуйте снова.",
      errorFailed: "Не удалось сбросить демо-данные. Повторите попытку или войдите снова, если сессия истекла.",
    },
    toasts: {
