...
export const en: Dictionary = {
  ...
  leads: {
    ...
    metrics: {
      ...
      rangeLabel: "Synthetic demo cohort: {range}",
      emptyTitle: "No leads in this period",
      emptyDescription: "Metrics appear once synthetic demo leads are created in the selected date range.",
      loadFailed: "Unable to load metrics.",
      funnel: {
        title: "Funnel milestones",
        stage: "Stage",
        count: "Leads",
      ...
      timing: {
        ...
        firstTerminal: "Time to first outcome",
        average: "Average",
        median: "Median",
        sampleSize: "Samples",
        noSamples: "No samples in this period.",
      },
      overdue: {
        title: "Current overdue snapshot",
        firstResponse: "First response",
        nextAction: "Next action",
        total: "Distinct overdue",
      },
      sources: {
    ...
    detail: {
      ...
      lossReasonRequired: "Enter a loss reason before confirming.",
